        ...
        <div class="tab-panel active" id="overview">
          ...
          <div class="quick-facts">
            ...
            <div class="fact-card qf-extra">
              ...
              <div class="fact-value">Full board, guided visits</div>
            </div>
            <div class="fact-card qf-extra">
          ...
          <div class="av-longform">
            ...
            <ul style="padding-left: 20px; color: var(--text-muted); font-size: 13px; line-height: 1.7; margin-bottom: 18px;">
              ...
              <li><strong>Abu Simbel:</strong> add a day trip from Aswan before you embark, or add the optional Abu Simbel excursion to our <a href="/nile-cruises/3-nights-nile-cruise-from-aswan-including-abu-simbel/" style="color:var(--primary-light);font-weight:600;text-decoration:underline;text-underline-offset:3px">3-night cruise from Aswan</a>.</li>
