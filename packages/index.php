...
<body data-rsssl=1 class="wp-singular page-template page-template-elementor_header_footer page page-id-10801 wp-custom-logo wp-theme-gofly-main tt-magic-cursor  theme-gofly-main woocommerce-no-js elementor-default elementor-template-full-width elementor-kit-7 elementor-page elementor-page-10801">
    ...
    <div class="container">
      ...
      <div class="cards-grid">
        ...
        <a class="package-card" href="/nile-cruises/3-nights-nile-cruise-from-aswan-including-abu-simbel/">
          ...
          <div class="card-body"><h3>3 Nights Nile River Cruise from Aswan with Optional Abu Simbel</h3><p>Classic Aswan to Luxor Nile cruise package with Kom Ombo, Edfu, and Luxor highlights, plus optional Abu Simbel.</p><div class="meta-row"><div class="meta"><span>Duration</span><strong>4 Days / 3 Nights</strong></div><div class="meta"><span>Route</span><strong>Aswan to Luxor</strong></div></div><div class="card-footer"><div class="price">$500/person</div><span class="view-link">View Details <i class="fas fa-arrow-right"></i></span></div></div>
        </a>
