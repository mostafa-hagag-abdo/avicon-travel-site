...
<title>Thank You - Avicon Travel</title>
<meta name="robots" content="noindex, follow">
<meta name="description" content="Your booking request has been received successfully. We&#039;re excited to help you explore Egypt."/>
<link rel="canonical" href="https://avicontravel.com/thank-you/" />
<meta property="og:locale" content="en_US" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Thank You - Avicon Travel" />
<meta property="og:description" content="Your booking request has been received successfully. We&#039;re excited to help you explore Egypt." />
<meta property="og:url" content="https://avicontravel.com/thank-you/" />
<meta property="og:site_name" content="Avicon Travel" />
<meta property="og:updated_time" content="2026-06-10T18:13:06+00:00" />
<meta property="article:published_time" content="2026-06-10T18:11:26+00:00" />
<meta property="article:modified_time" content="2026-06-10T18:13:06+00:00" />
<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:title" content="Thank You - Avicon Travel" />
<meta name="twitter:description" content="Your booking request has been received successfully. We&#039;re excited to help you explore Egypt." />
...
<link rel='stylesheet' id='elementor-post-11341-css' href='/assets/uploads/elementor/css/post-11341.css?ver=1788623329' type='text/css' media='all' />
...
<body data-rsssl=1 data-cmplz=1 class="wp-singular page-template page-template-elementor_header_footer page page-id-11341 wp-custom-logo wp-theme-gofly-main tt-magic-cursor  theme-gofly-main woocommerce-no-js elementor-default elementor-template-full-width elementor-kit-7 elementor-page elementor-page-11341">
<?php include $_SERVER['DOCUMENT_ROOT'].'/includes/header.php'; ?>
		<div data-elementor-type="wp-page" data-elementor-id="11341" class="elementor elementor-11341" data-elementor-post-type="page">
				<div class="elementor-element elementor-element-b75472b e-con-full e-flex e-con e-parent" data-id="b75472b" data-element_type="container" data-e-type="container">
				<div class="elementor-element elementor-element-a279b57 elementor-widget elementor-widget-html" data-id="a279b57" data-element_type="widget" data-e-type="widget" data-widget_type="html.default">
...
:root{
  ...
  --text-muted:#5A6B85;
  --border:#E1E8F0;
  --shadow-md:0 6px 20px rgba(26,79,196,.10);
  --shadow-lg:0 12px 32px rgba(26,79,196,.15);
}
...
/* ===== Body ===== */
.ty-body{padding:34px 28px 30px}
...
.ty-btn.whatsapp:hover{
  ...
  box-shadow:0 10px 24px rgba(37,211,102,.40);
}

.ty-btn.instagram{
  background:linear-gradient(135deg,#833AB4,#FD1D1D,#FCB045);
  color:#fff;
  box-shadow:0 6px 18px rgba(253,29,29,.25);
}
.ty-btn.instagram:hover{
  transform:translateY(-2px);
  box-shadow:0 10px 24px rgba(253,29,29,.35);
}
...
@media(max-width:520px){
  .ty-section{padding:24px 12px 40px}
  .ty-card{border-radius:18px}
  .ty-header{padding:34px 20px 44px}
  .ty-header h1{font-size:24px}
  .ty-check{width:74px;height:74px}
  .ty-check i{font-size:34px}
  .ty-body{padding:26px 18px 24px}
  .ty-steps{grid-template-columns:1fr;gap:10px}
  .ty-step{display:flex;align-items:center;text-align:left;gap:14px;padding:14px}
  .ty-step-icon{margin:0;flex-shrink:0}
  .ty-step-title{font-size:13px}
  .ty-step-desc{font-size:12px}
}
</style>
...
<section class="ty-section">
  <div class="ty-card">
    ...
    <div class="ty-header">
      ...
      <h1>Thank You!</h1>
      <p>Your booking request has been received successfully. We're excited to help you explore Egypt.</p>
    </div>

    <!-- Body -->
    <div class="ty-body">

      <div class="ty-subtitle">What happens next?</div>
      <p class="ty-text">Our travel experts are reviewing your request and will get back to you with a personalized plan and confirmation.</p>

      <!-- Steps -->
      <div class="ty-steps">
        <div class="ty-step">
          <div class="ty-step-icon"><i class="fas fa-envelope-open-text"></i></div>
          <div>
            <div class="ty-step-title">Request Received</div>
            <div class="ty-step-desc">We've got your details safely</div>
          </div>
        </div>
        <div class="ty-step">
          <div class="ty-step-icon"><i class="fas fa-headset"></i></div>
          <div>
            <div class="ty-step-title">We'll Contact You</div>
            <div class="ty-step-desc">Within 24 hours</div>
          </div>
        </div>
        <div class="ty-step">
          <div class="ty-step-icon"><i class="fas fa-plane-departure"></i></div>
          <div>
            <div class="ty-step-title">Start Your Journey</div>
            <div class="ty-step-desc">Your Egypt adventure begins</div>
          </div>
        </div>
      </div>

      <!-- CTAs -->
      <div class="ty-cta-label">Can't wait? Reach us now</div>
      <div class="ty-actions">
        <a href="https://wa.me/201200555600" class="ty-btn whatsapp" target="_blank" rel="noopener">
          <i class="fab fa-whatsapp"></i> Chat with us on WhatsApp
        </a>
        <a href="https://instagram.com/avicontravel" class="ty-btn instagram" target="_blank" rel="noopener">
          <i class="fab fa-instagram"></i> Follow us on Instagram
        </a>
        <a href="" class="ty-btn home">
      ...
      <!-- Footer -->
      <div class="ty-footer">
        Need help? Call us anytime at <strong>+20 120 055 5600</strong>
      </div>
...
<script type="text/javascript" id="gt_widget_script_85576587-js-before">
/* <![CDATA[ */
window.gtranslateSettings = /* document.write */ window.gtranslateSettings || {};window.gtranslateSettings['85576587'] = {"default_language":"en","languages":["zh-CN","nl","en","fr","de","it","pt","ru","es"],"url_structure":"none","detect_browser_language":1,"flag_style":"2d","flag_size":32,"wrapper_selector":"#gt-wrapper-85576587","alt_flags":[],"custom_css":".gtranslate_wrapper {\r\n    margin-top: 10px;\r\n}","horizontal_position":"inline","flags_location":"\/assets\/plugins\/gtranslate\/flags\/"};
//# sourceURL=gt_widget_script_85576587-js-before
/* ]]> */
</script><script src="/assets/plugins/gtranslate/js/popup.js?ver=3.1.1" data-no-optimize="1" data-no-minify="1" data-gt-orig-url="/thank-you/" data-gt-orig-domain="avicontravel.com" data-gt-widget-id="85576587" defer></script><script type="text/javascript" src="/assets/plugins/pro-elements/assets/js/webpack-pro.runtime.min.js?ver=4.1.0" id="elementor-pro-webpack-runtime-js"></script>
